...
Factories.size_shifter.register(settings.BinSizeMode.MINIMIZE_MAXIMAL, BinSizeShifterMaximal)
Factories.size_shifter.register(settings.BinSizeMode.MINIMIZE_POW2, BinSizeShifterPow2)
Factories.size_shifter.register(settings.BinSizeMode.MINIMIZE_POW2_MINIMIZE_LAST, BinSizeShifterPow2MinimizeLast)
...
from pypack2d.pack2d.packer.place_heuristic import (
