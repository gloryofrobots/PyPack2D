from pypack2d.pack.conveyer.validator import Validator
from pypack2d.pack.settings import ResizeMode, RotateMode
...
class PackingConveyerBuilder(object):
    def build(self, conveyer, factories, settings):
        ...
        if settings.resize_mode is None or settings.resize_mode == ResizeMode.STRICT:
            return
